...
public class gamejframe  extends JFrame implements KeyListener, ActionListener {
    ...
    private void initimage() {
        ...
        if (victory()) {
            JLabel win = new JLabel(new ImageIcon("E:\\学习\\java\\pingtu\\image\\win.png"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj == replayItem) {
            ...
            JLabel jLabel = new JLabel(new ImageIcon("E:\\学习\\java\\pingtu\\image\\IMG_20250726_191006.jpg"));
